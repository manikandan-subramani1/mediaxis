                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Bills & Payments</li>
                        </ol>
                    </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    {{-- {{-- <a href="{{url('add-bills')}}" class="btn btn-danger"><i class="ri-add-line align-bottom me-1"></i> Create Invoice</a> --}}
                                </div> 
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ asset('uploads/Profiles/' . $pat->image) }}" alt="" class="avatar-xxs rounded-circle image_src object-fit-cover">
                                                    </div>
                                            ...
                                            <td class="owner">
                                                @foreach ($data['bills'] as $bill)
                                                    @if ($bill->patient_id == $pat->patient_id)
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('add-bills',$pat->patient_id)}}" class="btn btn-primary"><i class="ri-add-line align-bottom me-1"></i> Add Bill</a>
                                                @foreach ($data['bills'] as $bill)
                                                    @if ($bill->patient_id == $pat->patient_id)
                                                        <a href="{{url('delete-bills', $bill->id)}}" class="btn btn-danger"><i class="ri-delete-bin-2-line align-bottom me-1"></i> Delete Bill</a>
                                                    @endif
                                                @endforeach
